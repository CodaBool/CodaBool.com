...
> The code is viewable [here](https://github.com/CodaBool/stat.codadash.com), README.md describles how to self-host
...
When the intented behavior is that the Total column would be in reverse from what is seen in the screenshot above.
