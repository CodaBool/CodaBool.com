...
This event was a special experience for me since it is the first time that I have pitched an idea.
...
There is usually also a theme or a set of sponsor as is the case this one which you are targeting.

For this I pitched an idea of using the voice recognition api provided by a sponsor.
The idea was that you would play the role of a GPS.
...
I was surprised to find that many of my teammates have not had git, vs code, or node installed on their machine.
So, this was something I walked a couple of them through. Most of them were freshman at colleges. 
I came to the event with the intention of helping younger attendees through.
...
This would be the first use of React for most and even the first use of JavaScript for one of them.
...
For us we luckly did not have any major compromise but there were several minor tweaks that needed to get made.
...
The code involved with drawing directions onto the screen was going to take too much time.
...
There is an additional conditional for ensuring the palyer can not go out of bounds.
...
The logic behind interpretting a person's voice can be found here.
...
This was pretty well recieved and made some laughs which is all I can really hope for.

This was filmed as far of Vincent Tang's TampaDevs popular Meetup group and streamed live to Twitch.
Afterwords it was then uploaded to YouTube, which was amazing to see.
