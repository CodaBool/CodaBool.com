...
RSS feeds make sense from a data distribuition perspective but offer little options in the way of monitization.
...
&emsp;
There is little benefit to YouTube for example to make their core API functions public and mass distrutable. 
...
For this reason Google is actively putting in measures to stop things like NewPipe from working and the app developers constantly need to do an arms race of updates to curcumvent barriers put in place by Google.
...
I also have built the habbit of creating ci/cd pipelines for my repositories to make my work as easy as a git push and the code is deployed. 
For this I used github actions to run a Serverless deploy which creates the lambda. 
Lastly I have my pipeline use the aws cli to get the CloudFormation stack output of the API gateway url and append that to the github readme for my convience.
...
This is a high level view and if you want a finer look at any of this code please checkout my [repo](https://github.com/CodaBool/p09-web-scraper)
...
> The result
<img src="/assets/byPost/16/embeds.PNG" size="lg" float />
...
## The Code
- [discord bot code](https://github.com/CodaBool/p09-scraper-consumer/blob/main/discord-bot/index.js)
- [sample code](https://github.com/CodaBool/p09-scraper-consumer)
- [scraper code](https://github.com/CodaBool/p09-web-scraper)