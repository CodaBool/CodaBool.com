...
There are just always going to be times when the simpliest approach is the one outside of the library.


## The problem
I wanted to have a table which could change from showing data to have editabled data.
...
This is something which you can try out by going [here](http://p10-managing-obesity.s3-website-us-east-1.amazonaws.com/track/weight/) and clicking the edit button.
