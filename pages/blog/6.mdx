...
<div className="video-grid">
  <Video autoPlay loop src="/assets/byPost/gameJam/loop_1.mp4" grid size="sm" />
  <Video autoPlay loop src="/assets/byPost/gameJam/loop_2.mp4" grid size="sm" />
  <Video autoPlay loop src="/assets/byPost/gameJam/loop_3.mp4" grid size="sm" />
  <Video autoPlay loop src="/assets/byPost/gameJam/game_over.mp4" grid size="sm" />
</div>
