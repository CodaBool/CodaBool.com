...
<video controls="controls" src="/assets/byPost/gameJam/gameplay.mp4" pos='center'></video>

<br /><br /><br />

<div className="video-grid">
  <video autoPlay loop src="/assets/byPost/gameJam/loop_1.mp4" grid size="sm"></video>
  <video autoPlay loop src="/assets/byPost/gameJam/loop_2.mp4" grid size="sm"></video>
  <video autoPlay loop src="/assets/byPost/gameJam/loop_3.mp4" grid size="sm"></video>
  <video autoPlay loop src="/assets/byPost/gameJam/game_over.mp4" grid size="sm"></video>
</div>
