...
<div className="video-grid">
  <video autoPlay loop src="/assets/byPost/ellucian-callcenter/ellucian-arrows.mp4" grid size="sm"></video>
  <video autoPlay loop src="/assets/byPost/ellucian-callcenter/ellucian-fight.mp4" grid size="sm"></video>
  <video autoPlay loop src="/assets/byPost/ellucian-callcenter/ellucian-game.mp4" grid size="sm"></video>
  <video controls="controls" onloadstart="this.volume=0.5" src="/assets/byPost/ellucian-callcenter/ellucian-runs.mp4" grid size="sm"></video>
</div>
