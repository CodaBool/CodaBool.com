...
# Type fast to win
> This is a live project! play [here](https://codabool.com/projects#8)
...
This made for all the basic features of the app, a type race, using styling to show progress and finally a chat embeded within the same socket for the game data.
...
I used chrome browser extenstion [Web Scraper - Free Web Scraping](https://chrome.google.com/webstore/detail/web-scraper-free-web-scra/jnhgnonknehpejjnehehllkliplmbmhn) which allowed me to scrape data programmatically from pages.
...
This is particularrly inefficient due to the updates to game state which happen with the timer, all members of the socket are getting those new game update emits.
...
I did not have accounts or want to add authenication to the app. 
...
Everytime a game was created it would be stored and this can quickly lead to a overfilled database with no reason for keeping most of its collections.
...
&emsp;
Did I already say you can play it? [Play now](https://codabool.com/projects#8)
# Thanks for reading 👍
&emsp;
