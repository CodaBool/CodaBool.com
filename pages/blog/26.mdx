...
export default ({ children }) => {
  const meta = {
    ...
    "excerpt": "I learned a lot this semester and worked with a group to analyse some real work data for my final. I used this to create a Python script which did data analysis. Popular Python libraries like pandas and matplotlib were essential for our final.",
...
I am censoring the name of the applications due to the specifics of the findings being private information for this class.
...
To fully interpret the correltation data you could say that:
