    ...
    <div className="container mx-auto my-10">
      <div className="flex flex-col items-center md:flex-row">
        ...
        <div className="w-full mb-8 md:w-1/2">
          ...
          <p className="m-5 text-xl">&emsp;I am a DevOps engineer, but I also do full-stack development outside of work. I mainly work with <strong>AWS</strong>. I like to use PostgreSQL + Prisma for my database solutions. For my full stack projects I enjoy Next.js. But recently I've also been using Go for backend projects. You can see more on my projects and blog pages. <b style={{ fontWeight: 550 }}>Thanks for visiting</b>. </p>
        </div>
      </div>
      <br />
      <div className="flex flex-col items-center md:flex-row">
