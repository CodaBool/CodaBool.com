...
description: "Created for a school project. This is a mock local website for selling tech support. Services include a home appointment request form and even a mock live chat. There are picture modals in the gallery. As well as some fun CSS for a company history timeline. Check this one out."
publishedTime: "2019-04-14"
cover: "/coverImg/tech-cover.jpg"
...
> Appointment Service
> <Video autoPlay loop src="/posts/4/service.mp4" />
...
> Chat Service
> <Video autoPlay loop src="/posts/4/Chat.mp4" />
...
> Gallery
> <Video autoPlay loop src="/posts/4/gallery.mp4" />
...
> About page
> <Img src="/posts/4/about-page.jpg" float size="lg" />
