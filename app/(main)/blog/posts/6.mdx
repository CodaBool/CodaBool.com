...
description: "I participated in the Orlando Game Jam and created a Nodejs browser game called Asteroid BattleGrounds. It is made using a framework called Phaser. This was a lot of fun and I hope to do another soon."
publishedTime: "2019-09-27"
cover: "/coverImg/asteroid-battlegrounds.jpg"
...
<Img src="/posts/6/poster.jpg" size="lg" />
...
<Video controls="controls" src="/posts/6/gameplay.mp4" pos='center' />

<br /><br /><br />

<div className="video-grid">
  <Video autoPlay loop src="/posts/6/loop_1.mp4" grid="true" size="sm" />
  <Video autoPlay loop src="/posts/6/loop_2.mp4" grid="true" size="sm" />
  <Video autoPlay loop src="/posts/6/loop_3.mp4" grid="true" size="sm" />
  <Video autoPlay loop src="/posts/6/game_over.mp4" grid="true" size="sm" />
</div>

<br /><br /><br />

> Original Music
<audio controls src="/posts/6/register.mp3" className="w-100">Your browser does not support the audio element</audio>
